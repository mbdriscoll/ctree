...
class cl_device_id(OclType):     pass
class cl_context(OclType):       pass
class cl_command_queue(OclType): pass
class cl_program(OclType):       pass
class cl_kernel(OclType):        pass
class cl_mem(OclType):           pass
