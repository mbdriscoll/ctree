...
class TestJit(unittest.TestCase):
    def test_identity(self):
        ...
        mod._link_in(submod)
        c_identity_fn = mod.get_callable(identity_ast.name, identity_ast.get_type().as_ctype())
    ...
    def test_fib(self):
        ...
        mod._link_in(submod)
        c_fib_fn = mod.get_callable(fib_ast.name, fib_ast.get_type().as_ctype())
    ...
    def test_gcd(self):
        ...
        mod._link_in(submod)
        c_gcd_fn = mod.get_callable(gcd_ast.name, gcd_ast.get_type().as_ctype())
